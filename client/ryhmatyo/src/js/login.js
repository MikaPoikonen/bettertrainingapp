// Login.js käsittelee käyttäjien kirjautumisen backendiin. Se lähettää POST-pyynnön login-endpointiin,
// ja jos kirjautuminen onnistuu, tallentaa tokenin localStorageen ja hakee Kubios-dataa.
...
document.querySelector(".loginform").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    if (!kubiosResponse.ok) {
      ...
      alert(
        "Kirjautuminen onnistui, mutta Kubios‑datan tallennus epäonnistui.",
      );
      return;
    }
